<?php
  ...
  $elements = [
    ...
    [
      ...
      'element'    => form_dropdown('status', $form_status, esc($item['status'] ?? 1), ['class' => $class_element]),
      'class_main' => "col-md-12 col-sm-12 col-xs-12",
    ],
    [
      'label'      => form_label('Description'),
      'element'    => form_textarea(['name' => 'description', 'value' => esc($item['description'] ?? ''), 'rows' => '3', 'class' => $class_element]),
