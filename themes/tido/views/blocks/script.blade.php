    ...
    <script type="text/javascript" src="<?php echo BASE; ?>themes/tido/assets/js/swiper.min.js"></script> 
    <script type="text/javascript" src="<?php echo BASE; ?>themes/tido/assets/js/monoka.js"></script>
