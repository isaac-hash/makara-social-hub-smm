<?php
  $payment_elements = [
    ...
    [
      'label'      => form_label('Encryption Key'),
      'element'    => form_input(['name' => "payment_params[option][encryption_key]", 'value' => @$payment_option->encryption_key, 'type' => 'text', 'class' => $class_element]),
      'class_main' => "col-md-12 col-sm-12 col-xs-12",
    ],
  ];
