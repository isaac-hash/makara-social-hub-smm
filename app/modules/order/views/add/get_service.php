<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="form-group">
    ...
    <input class="form-control square" name="service_name" type="text" value="<?=$service['name']?>" readonly>
  </div>
</div>   
...
<div class="col-md-4  col-sm-12 col-xs-12">
  <div class="form-group">
    ...
    ?>
    <input class="form-control square" type="text" name="service_price_show" value="<?=show_price_format($user_price);?>" readonly>
    <input class="form-control square" type="hidden" name="service_price" value="<?=$user_price;?>">
  </div>
</div>
