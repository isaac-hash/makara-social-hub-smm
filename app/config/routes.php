...
$route['cron/multiple_refill_status']   = 'refill/cron_multi_refill_status';
$route['cron/sync_services']            = 'cron/provider/sync_services';
$route['cron/average_time']             = 'cron/services/update_avg_time';
