...
<?php }?>
<?php if (segment('2') == 'blog_posts'  || segment('3') == 'website_setting' ) { ?>
    <script type="text/javascript" src="<?php echo BASE; ?>assets/plugins/bootstrap-tagsinput/tagsinput.js"></script>
<?php }?>
