<?php
  ...
  $elements_item_detail = [
    ...
    [
      'label' => form_label('Overflow, % ' . render_tooltip_popover_html('Automatically increases quantity by percentage. <br> E.g., 100 with 20% overflow → system sends 120.', 'popover', 'right')),
