...
<aside class="navbar navbar-side navbar-fixed js-sidebar" id="aside">
  <div class="mobile-logo">
    <a href="<?php echo admin_url('statistics'); ?>" class="navbar-brand text-inherit">
      <img src="https://res.cloudinary.com/dlkfqsjgg/image/upload/v1760352921/logo_famnk2.png" alt="Website Logo" class="hide-navbar-folded navbar-brand-logo">
      <img src="https://res.cloudinary.com/dlkfqsjgg/image/upload/v1760352921/logo_famnk2.png" alt="Website Logo" class="hide-navbar-expanded navbar-brand-logo">
    </a>
  </div>
