...
<header class="navbar navbar-expand-xl js-header">
  <div class="header-wrap">
    ...
    <a href="<?php echo cn(); ?>" class="navbar-brand text-inherit mr-md-3">
      <img src="https://res.cloudinary.com/dlkfqsjgg/image/upload/v1760352921/logo_famnk2.png" alt="Website Logo" class="d-md-none navbar-brand-logo">
    </a>
      ...
      <li class="nav-item dropdown">
        <a href="#" data-toggle="dropdown" class="nav-link d-flex align-items-center py-0 px-lg-0 px-2 text-color ml-2">
          <span class="ml-2 d-none d-lg-block leading-none">
            <span class="mt-1"><?php echo lang('Hi'); ?>! <?php echo current_logged_staff()->first_name; ?> </span>
          </span>
