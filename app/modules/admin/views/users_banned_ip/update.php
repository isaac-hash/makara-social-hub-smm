<?php
    ...
    $elements = [
        [
            'label'      => form_label('IP Address'),
            'element'    => form_input(['name' => 'ip_address', 'value' => @$item['ip'], 'type' => 'text', 'class' => $class_element]),
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <small>This feature will allow you to block a range of IP addresses to prevent them from accessing your site (register, login).</small>
                </div>
            </div>
